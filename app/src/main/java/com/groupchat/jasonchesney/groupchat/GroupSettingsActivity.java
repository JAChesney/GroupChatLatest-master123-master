...
public class GroupSettingsActivity extends AppCompatActivity {
    ...
    private String currentUserID, retrievename;
        ...
        updatebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(updatename != null) {
                    ...
                    grpset.put(retrievename, fetchname);
        ...
        rootRef.child("GroupOwner").child(phonead).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if((dataSnapshot.exists()) && (dataSnapshot.hasChild("gtitle")) && dataSnapshot.hasChild("timer")){
                    retrievename = dataSnapshot.child("gtitle").getValue().toString();
                    ...
                    Toast.makeText(GroupSettingsActivity.this, "Update your group", Toast.LENGTH_SHORT).show();
                }
            }
